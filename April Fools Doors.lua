...
if game:GetService("ReplicatedStorage").GameData.Floor.Value ~= "Retro" then
	notify("", nil, "Only Work On Retro Mode!")
	return
end
...
local BlackKing = loadstring(game:HttpGet("https://raw.githubusercontent.com/KINGHUB01/Gui/main/Gui%20Lib%20%5BLibrary%5D"))()

local Window = BlackKing:CreateWindow({
